...
namespace aaasm.engine.lxpr
{
    ...
    public class ETypeI32 : EType
    {
        ...
        private static readonly ImmNullDict<EType, ETypeBinaryOp> SHIFTL_OPS = new([
            new(U8, new(I32, U8, I32, (a, b) => 
                (EValue)EMathUtil.ShiftL((EI32)MM_ValidateType(a, I32), (EU8)MM_ValidateType(b, U8)))),
            new(I8, new(I32, I8, I32, (a, b) => 
                (EValue)EMathUtil.ShiftL((EI32)MM_ValidateType(a, I32), (EI8)MM_ValidateType(b, I8)))),
            new(U16, new(I32, U16, I32, (a, b) => 
                (EValue)EMathUtil.ShiftL((EI32)MM_ValidateType(a, I32), (EU16)MM_ValidateType(b, U16)))),
            new(I16, new(I32, I16, I32, (a, b) => 
                (EValue)EMathUtil.ShiftL((EI32)MM_ValidateType(a, I32), (EI16)MM_ValidateType(b, I16)))),
            new(U32, new(I32, U32, U32, (a, b) => 
                (EValue)EMathUtil.ShiftL((EI32)MM_ValidateType(a, I32), (EU32)MM_ValidateType(b, U32)))),
            new(I32, new(I32, I32, I32, (a, b) => 
                (EValue)EMathUtil.ShiftL((EI32)MM_ValidateType(a, I32), (EI32)MM_ValidateType(b, I32)))),
            new(U64, new(I32, U64, U64, (a, b) => 
                (EValue)EMathUtil.ShiftL((EI32)MM_ValidateType(a, I32), (EU64)MM_ValidateType(b, U64)))),
            new(I64, new(I32, I64, I64, (a, b) => 
                (EValue)EMathUtil.ShiftL((EI32)MM_ValidateType(a, I32), (EI64)MM_ValidateType(b, I64)))),
        ]);

        private static readonly ImmNullDict<EType, ETypeBinaryOp> SHIFTR_OPS = new([
            new(U8, new(I32, U8, I32, (a, b) => 
                (EValue)EMathUtil.ShiftR((EI32)MM_ValidateType(a, I32), (EU8)MM_ValidateType(b, U8)))),
            new(I8, new(I32, I8, I32, (a, b) => 
                (EValue)EMathUtil.ShiftR((EI32)MM_ValidateType(a, I32), (EI8)MM_ValidateType(b, I8)))),
            new(U16, new(I32, U16, I32, (a, b) => 
                (EValue)EMathUtil.ShiftR((EI32)MM_ValidateType(a, I32), (EU16)MM_ValidateType(b, U16)))),
            new(I16, new(I32, I16, I32, (a, b) => 
                (EValue)EMathUtil.ShiftR((EI32)MM_ValidateType(a, I32), (EI16)MM_ValidateType(b, I16)))),
            new(U32, new(I32, U32, U32, (a, b) => 
                (EValue)EMathUtil.ShiftR((EI32)MM_ValidateType(a, I32), (EU32)MM_ValidateType(b, U32)))),
            new(I32, new(I32, I32, I32, (a, b) => 
                (EValue)EMathUtil.ShiftR((EI32)MM_ValidateType(a, I32), (EI32)MM_ValidateType(b, I32)))),
            new(U64, new(I32, U64, U64, (a, b) => 
                (EValue)EMathUtil.ShiftR((EI32)MM_ValidateType(a, I32), (EU64)MM_ValidateType(b, U64)))),
            new(I64, new(I32, I64, I64, (a, b) => 
                (EValue)EMathUtil.ShiftR((EI32)MM_ValidateType(a, I32), (EI64)MM_ValidateType(b, I64)))),
        ]);

        private static readonly ImmNullDict<EType, ETypeBinaryOp> SHIFTRU_OPS = new([
            new(U8, new(I32, U8, I32, (a, b) => 
                (EValue)EMathUtil.ShiftRU((EI32)MM_ValidateType(a, I32), (EU8)MM_ValidateType(b, U8)))),
            new(I8, new(I32, I8, I32, (a, b) => 
                (EValue)EMathUtil.ShiftRU((EI32)MM_ValidateType(a, I32), (EI8)MM_ValidateType(b, I8)))),
            new(U16, new(I32, U16, I32, (a, b) => 
                (EValue)EMathUtil.ShiftRU((EI32)MM_ValidateType(a, I32), (EU16)MM_ValidateType(b, U16)))),
            new(I16, new(I32, I16, I32, (a, b) => 
                (EValue)EMathUtil.ShiftRU((EI32)MM_ValidateType(a, I32), (EI16)MM_ValidateType(b, I16)))),
            new(U32, new(I32, U32, U32, (a, b) => 
                (EValue)EMathUtil.ShiftRU((EI32)MM_ValidateType(a, I32), (EU32)MM_ValidateType(b, U32)))),
            new(I32, new(I32, I32, I32, (a, b) => 
                (EValue)EMathUtil.ShiftRU((EI32)MM_ValidateType(a, I32), (EI32)MM_ValidateType(b, I32)))),
            new(U64, new(I32, U64, U64, (a, b) => 
                (EValue)EMathUtil.ShiftRU((EI32)MM_ValidateType(a, I32), (EU64)MM_ValidateType(b, U64)))),
            new(I64, new(I32, I64, I64, (a, b) => 
                (EValue)EMathUtil.ShiftRU((EI32)MM_ValidateType(a, I32), (EI64)MM_ValidateType(b, I64)))),
        ]);
