...
namespace aaasm.engine.lxpr
{
    public partial class EMathUtil
    {
        ...
        /// </exception>
        public static IENumber ShiftL(EU8 input, IEInteger amount)
        {
            try
            {
                var _input = input.ToInt();
                var _amount = amount.ToShift();
                return new EU8(unchecked((byte)((_input << _amount) & 255)));
            }
            catch when (input is null)
            { throw new ArgumentNullException(nameof(input)); }
        ...
        ///     <paramref name="amount"/> is null
        /// </exception>
        public static IENumber ShiftR(EU8 input, IEInteger amount)
        {
            try
            {
                var _input = input.ToInt();
        ...
        ///     <paramref name="amount"/> is null
        /// </exception>
        public static IENumber ShiftRU(EU8 input, IEInteger amount)
        {
            try
            {
                var _input = input.ToInt();
