...
namespace aaasm.engine.lxpr
{
    public partial class EMathUtil
    {
        ...
        /// </exception>
        public static IENumber ShiftL(EI16 input, IEInteger amount)
        {
            try
            {
                var _input = input.ToInt();
                var _amount = amount.ToShift();
                return new EI16(unchecked((short)((_input << _amount) & 65535)));
            }
            catch when (input is null)
            { throw new ArgumentNullException(nameof(input)); }
        ...
        ///     <paramref name="amount"/> is null
        /// </exception>
        public static IENumber ShiftR(EI16 input, IEInteger amount)
        {
            try
            {
                var _input = input.ToInt();
        ...
        ///     <paramref name="amount"/> is null
        /// </exception>
        public static IENumber ShiftRU(EI16 input, IEInteger amount)
        {
            try
            {
                var _input = input.ToInt() & 0xFFFF;
                var _amount = amount.ToShift();
                return new EI16(unchecked((short)((_input >>> _amount) & 65535)));
            }
            catch when (input is null)
